...
if __name__ == "__main__":
    ...
    devices_model.add([SPZigbeeDevice(id_ = "LED2", type_ = "led"),  # Add devices to model
                       SPZigbeeDevice(id_ = "LED3", type_ = "led"),
                       SPZigbeeDevice(id_ = "LED4", type_ = "led"),
                       SPZigbeeDevice(id_ = "NEO", type_ = "power plug"),
                       SPZigbeeDevice(id_ = "PIR1", type_ = "pir"), # Associate PIR with LED 
                       SPZigbeeDevice(id_ = "PIR2", type_ = "pir", LED_friend="LED2"),
                       SPZigbeeDevice(id_ = "PIR3", type_ = "pir", LED_friend="LED3"), 
                       SPZigbeeDevice(id_ = "PIR4", type_ = "pir", LED_friend="LED4")])
